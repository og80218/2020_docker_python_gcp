...
#由個股新聞帶入
def stock_reply_other_news(stockNumber):
    content_text = "想知道更多?"
    text_message = TextSendMessage(
                                text = content_text ,
                               quick_reply=QuickReply(
...
#由個股交易資訊帶入
def stock_reply_other_price(stockNumber, content_text):
    text_message = TextSendMessage(
                                text = content_text ,
                               quick_reply=QuickReply(
                                   items=[
...
#由K圖帶入
def stock_reply_other_K(stockNumber):
    content_text = "想知道更多?"
    text_message = TextSendMessage(
                                text = content_text ,
                               quick_reply=QuickReply(
...
#由MACD圖帶入
def stock_reply_other_MACD(stockNumber):
    content_text = "想知道更多?"
    text_message = TextSendMessage(
                                text = content_text ,
                               quick_reply=QuickReply(
...
#由RSI圖帶入
def stock_reply_other_RSI(stockNumber):
    content_text = "想知道更多?"
    text_message = TextSendMessage(
                                text = content_text ,
                               quick_reply=QuickReply(
...
#由BBAND圖帶入
def stock_reply_other_BBAND(stockNumber):
    content_text = "想知道更多?"
    text_message = TextSendMessage(
                                text = content_text ,
                               quick_reply=QuickReply(
...
#由股價走勢圖帶入
def stock_reply_other_P(stockNumber):
    content_text = "想知道更多?"
    text_message = TextSendMessage(
                                text = content_text ,
                               quick_reply=QuickReply(
...
#由年收益率分析圖帶入
def stock_reply_other_E(stockNumber):
    content_text = "想知道更多?"
    text_message = TextSendMessage(
                                text = content_text ,
                               quick_reply=QuickReply(
...
#由三大法人買賣資訊帶入
def stock_reply_other_F(stockNumber):
    content_text = "想知道更多?"
    text_message = TextSendMessage(
                                text = content_text ,
                               quick_reply=QuickReply(
